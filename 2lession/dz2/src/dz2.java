...
//1
        ...
        getArr(2, arr1); // заполняем массив рандомными числами первый параметр интервал рандомных чисел, туто от 0-1
        printArr(arr1,"- исходный массив.");        //печатаем первый массив с рандомными числами
        arrChange(arr1);        //меняем значения в массиве
        printArr(arr1, "- измененный массив.");        //печатаем измененный массив:
...
//2
        ...
        printArr(arr2,"- с помощью цикла созданн массив для второго адания");        //печатаем массива
...
//3
        ...
        printArr(arr3,"- исходный массив.");        //печатаем исходный массив
        arrChange3(arr3);        //меняем значения в массиве
        printArr(arr3,"- новый массив с увеличенными значениями");        //печатаем новый массив
...
//4
        ...
        printArr4(arr4);        //печатаем квадрптный массив
...
//5
        ...
        getArr(100, arr5); // заполняем массив рандомными числами первый параметр интервал рандомных чисел, туто от 0-100
        printArr(arr5,"- исходный массив.");        //печатаем исходный массив
...
//6
    ...
    //далее следует упрощенный вариант, массив введен руками, для безпристрастности, можно нижнюю строку закоментить, а верхние две разкоментить.
        ...
        printArr(arr6,"- исходный массив.");        //печатаем исходный массив
...
//7
        ...
        int n = readArg("Введите число n: "); //просим пользователя ввести число n
    ...
    //далее следует упрощенный вариант, массив введен руками, для безпристрастности, можно нижнюю строку закоментить, а верхние две разкоментить.
        ...
        printArr(arr7,"- исходный массив.");        //печатаем исходный массив
        arrChange7(arr7, n);        //метод для сдвига занчений в массиве на n позиций
        printArr(arr7,"- итоговый массив.");        //печатаем исходный массив
...
// метод для печати одномерного массива:
    public static void printArr(int[] arr, String comment){
        for (int value : arr) {
    ...
    public static void arrChange7(int arr[], int n){
        if (n==0) return; //если n = 0 то ни чего не двигаем
            ...
            for (int j = n; j>0 ; j--) { // цикл для итераций = числу n
                ...
                printArr(arr,"- массив на шаге "+ j); //строку можно закоментить чтоб не смотреть шаги перемещения элементов
            }
